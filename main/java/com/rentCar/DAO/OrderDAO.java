...
public class OrderDAO {
    ...
    public boolean createNewOrder(Order order) {
        ...
        logger.info("I am into OrderDAO.createNewOrder");
...
//                Date newRentStart = new Date(order.getRentStart().getTime() + TimeUnit.DAYS.toMillis(1));
//                Date newRentEnd = new Date(order.getRentEnd().getTime() + TimeUnit.DAYS.toMillis(1));
...
//                System.out.println(newRentStart);
//                System.out.println(newRentEnd);
                System.out.println("------------------------------------------------------");
            }
